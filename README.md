...
エラー: ビルド依存性の失敗:
        ...
        gdbm-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        glibc-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        gcc は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        openssl-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        libyaml-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
...
書き込み完了: /home/vagrant/rpmbuild/RPMS/x86_64/ruby-debuginfo-2.2.3-1.el7.centos.x86_64.rpm
```
...
$ sudo yum update -y
$ sudo yum install -y rpm-build
$ curl -LO https://github.com/feedforce/ruby-rpm/releases/download/2.2.3/ruby-2.2.3-1.el7.centos.src.rpm
$ rpmbuild --rebuild ruby-2.2.3-1.el7.centos.src.rpm
ruby-2.2.3-1.el7.centos.src.rpm をインストール中です。
エラー: ビルド依存性の失敗:
        readline-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        ncurses-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
        gdbm-devel は ruby-2.2.3-1.el7.centos.x86_64 に必要とされています
